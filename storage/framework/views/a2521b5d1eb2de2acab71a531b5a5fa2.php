...
<?php $__env->startSection('title', 'Historia logowań'); ?>
...
<div class="min-h-screen bg-cover bg-center relative" style="background-image: url('/img/3.png');">
    ...
    <div class="relative z-10 max-w-4xl mx-auto mt-16 bg-white bg-opacity-95 dark:bg-gray-900 dark:bg-opacity-90 p-6 rounded-lg shadow-lg">
        <h2 class="text-2xl font-bold mb-6 text-gray-800 dark:text-white">
            Historia logowań – <?php echo e($user->name); ?>
                ...
                <tbody class="bg-white dark:bg-gray-800">
                    <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                            <td class="p-3"><?php echo e($log->created_at->setTimezone('Europe/Warsaw')->format('d.m.Y H:i')); ?></td>
                            <td class="p-3"><?php echo e($log->ip_address); ?></td>
                            <td class="p-2">
                                <?php
        ...
        <a href="<?php echo e(route('admin.index')); ?>" class="text-indigo-600 hover:underline text-sm">← Wróć do listy użytkowników</a>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rejestr_zwierzat\resources\views/admin/logs.blade.php ENDPATH**/ ?>