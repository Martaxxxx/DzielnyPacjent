...
<?php $__env->startSection('title', 'Panel Weterynarza'); ?>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="border-b border-gray-200 even:bg-gray-50 dark:border-gray-700 dark:even:bg-gray-800">
                            <td class="px-4 py-2"><?php echo e($appointment->owner_name); ?></td>
                            <td class="px-4 py-2"><?php echo e($appointment->pet_name); ?></td>
                            <td class="px-4 py-2"><?php echo e(\Carbon\Carbon::parse($appointment->appointment_date)->format('d.m.Y H:i')); ?></td>
                            <td class="px-4 py-2">
                                <?php echo e($appointment->description ? Str::limit($appointment->description, 30) : '—'); ?>

                            </td>
                            <td class="px-4 py-2">
                                <?php echo e($appointment->prescription ? Str::limit($appointment->prescription, 30) : '—'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rejestr_zwierzat\resources\views/vet/index.blade.php ENDPATH**/ ?>