...
<div class="max-w-3xl mx-auto mt-10 p-6 bg-white dark:bg-gray-900 shadow rounded">
    ...
    <form method="POST" action="{{ route('vet.zapisz', $appointment->id) }}">
        ...
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('vet.recepta', $appointment->id) }}" target="_blank" class="bg-[#8B5CF6]  hover:bg-blue-700 text-white px-4 py-2 rounded flex items-center gap-2 print:hidden">
